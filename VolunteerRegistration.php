  ...
  <div class="reg_img">
    ...
    <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        $sql="SELECT Volunteer_ID from `volunteer`";
        $res=mysqli_query($db,$sql);

        while($row=mysqli_fetch_assoc($res))
        {
          if($row['Volunteer_ID']==$_POST['Volunteer_ID'])
          {
            $count=$count+1;
          }
        }
        if($count==0)
        {
          mysqli_query($db,"INSERT INTO `VOLUNTEER` VALUES('$_POST[Volunteer_ID]', '$_POST[Name]', '$_POST[Date_of_Birth]', '$_POST[password]', '$_POST[Interest]', '$_POST[Location]', '$_POST[Contact]');");
        ?>
