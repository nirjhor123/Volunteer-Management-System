...
<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #6db6b9e6;" type="submit" name="submit1" class="btn btn-default">Delete_Event
				</button>
		</form>
	</div>
<section>
  <div class="reg_img">
    ...
    <div class="box2">
        ...
        <h1 style="text-align: center; font-size: 25px;">Adding Event</h1>
    ...
    <?php
      ...
      if(isset($_POST['submit']))
      {
        $count=0;
          ...
          mysqli_query($db,"INSERT INTO `event_name` (`Event_ID`, `Event_Name`, `Location`, `Event_Date`, `Description`) VALUES('$_POST[Event_ID]', '$_POST[Event_Name]', '$_POST[Location]','$_POST[Event_Date]','$_POST[Description]');");
        ?>
        ...
        if(isset($_POST['submit1'])){
            mysqli_query($db,"DELETE FROM `event_name` WHERE Event_ID='$_POST[Event_ID]'; ");
            ?>
               <script type="text/javascript">
                              window.location="addevent3.php"
                          </script>
            <?php
          }
