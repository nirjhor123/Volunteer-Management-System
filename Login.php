...
<section>
   ...
   <br>
    <div class="box1">
      ...
      <p style="color: white; padding-left: 15px;">
       ...
       <a style="color:yellow; text-decoration: none;" New to this website?<a style="color: yellow; text-decoration: none;" href="VolunteerRegistration.php">&nbspSign Up</a>
      </p>
    </form>
    </div>
  </div>
  ...
  <?php
    ...
    {
      $count=0;
      $res=mysqli_query($db,"SELECT * FROM `VOLUNTEER` WHERE Volunteer_ID='$_POST[Volunteer_ID]' && password='$_POST[password]';");
      ...
      {
        $_SESSION['login_user'] = $_POST['Volunteer_ID'];
