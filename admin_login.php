...
<section>
   ...
   <br>
    <div class="box1">
      ...
      <form  name="login" action="" method="post">
        ...
        <div class="login">
          <input class="form-control" type="text" name="Admin_ID" placeholder="Admin_ID" required=""> <br>
          <input class="form-control" type="password" name="Admin_Password" placeholder="Admin_Password" required=""> <br>
  ...
  <?php
    ...
    {
      $count=0;
      $res=mysqli_query($db,"SELECT * FROM `admin` WHERE Admin_ID='$_POST[Admin_ID]' && Admin_Password='$_POST[Admin_Password]';");
